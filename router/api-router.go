...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/contact/qr-code/:id", controller.GetContactQRCode)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/ip-risk", controller.GetUserIPRisks)
				adminRoute.POST("/ip-risk/related", controller.GetUsersRelatedByIP)
				adminRoute.POST("/ip-risk/block", controller.BlockRegistrationIPs)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.POST("/contact-wechat-qrcode", controller.UploadContactQRCode)
